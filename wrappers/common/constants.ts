...
export const Op = {
  ...
  factory_tranfer_admin: c('factory_tranfer_admin'),
  factory_new_fee_recipient: c('factory_new_fee_recipient'),
  factory_set_permissionless: c('factory_set_permissionless'),
  factory_new_plain_pool: c('factory_new_plain_pool'),
  factory_new_meta_pool: c('factory_new_meta_pool'),
}
