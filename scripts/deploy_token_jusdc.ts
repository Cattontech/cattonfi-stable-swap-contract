...
async function deploy(provider: NetworkProvider, admin: Address) {
  ...
  // https://tonviewer.com/EQB-MPwrd1G6WKNkLz_VnV6WqBDd142KMQv-g1O-8QUA3728
  const meta = {
    decimals: '6',
    symbol: 'jUSDC',
    name: 'Bridged jUSDC',
    description:
      'USDC transferred from Ethereum via bridge.ton.org. Token address in Ethereum: 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48',
    image:
      'https://cache.tonapi.io/imgproxy/Ah3zvC4pJ0jg74ymj38e_FF-2ALz-5aqRD9ZUYVAacU/rs:fill:200:200:1/g:no/aHR0cHM6Ly9icmlkZ2UudG9uLm9yZy90b2tlbi8xLzB4YTBiODY5OTFjNjIxOGIzNmMxZDE5ZDRhMmU5ZWIwY2UzNjA2ZWI0OC5wbmc.webp',
  }
